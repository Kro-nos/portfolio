...
const SiteHead = ({ title }) => (
  <Head>
    <title>{title}</title>
    <meta name="title" content="Yuvraj Gajani - Full Stack Developer" />
    <meta name="description" content="Yuvraj Gajani - Portfolio" />
    <meta name="author" content="Yuvraj Gajani" />
...
function MyApp({ Component, pageProps }) {
  ...
  const pathToTitle = {
    "/": "Yuvraj Gajani - Full Stack Developer"
  };
